...
If you want to use other OpenAI compatible providers, override the base url and the model names in the `.env` file too.
```env
...
OPENAI_CHAT_MODEL=your_api_provider_chat_model_name
```
